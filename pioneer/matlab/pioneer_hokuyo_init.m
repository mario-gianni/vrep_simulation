...
% These transformations are stored in h.hokuyo1Trans and h.hokuyo2Trans
  ...
  % Compute the transformations between the two Hokuyo subsensors and the
  % pioneer ref frame h.ref
